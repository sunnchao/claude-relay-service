<template>
  <!-- 顶部导航 -->
  <div
    class="glass-strong mb-4 rounded-none p-3 shadow-xl sm:mb-6 sm:rounded-none sm:p-4 md:mb-8 md:rounded-none md:p-6"
    ...
    <div class="flex flex-col items-center justify-between gap-3 sm:flex-row sm:gap-4">
          ...
          <template #after-title>
            ...
            <div class="flex items-center gap-1 sm:gap-2">
              ...
              <a
                ...
                class="inline-flex animate-pulse items-center gap-1 rounded-none border border-green-600 bg-green-500 px-2 py-0.5 text-xs text-white transition-colors hover:bg-green-600"
      ...
      <div class="flex items-center gap-2 sm:gap-4">
        ...
        <div class="user-menu-container relative">
          <button
            class="user-menu-button flex items-center gap-2 rounded-none bg-gradient-to-r from-blue-500 to-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl active:scale-95 sm:px-4 sm:py-2.5"
          ...
          <div
            v-if="userMenuOpen"
            class="user-menu-dropdown absolute right-0 top-full mt-2 w-48 rounded-none border border-gray-200 bg-white py-2 shadow-xl dark:border-gray-700 dark:bg-gray-800 sm:w-56"
          ...
          >
            ...
            <div class="border-b border-gray-100 px-4 py-3 dark:border-gray-700">
              ...
              <div v-if="versionInfo.hasUpdate" class="mt-2">
                ...
                <a
                  class="block w-full rounded-none bg-green-500 px-3 py-1.5 text-center text-sm text-white transition-colors hover:bg-green-600"
                  :href="versionInfo.releaseInfo?.htmlUrl || '#'"
                  target="_blank"
                >
              ...
              <div v-else class="mt-2 text-center">
                ...
                <transition mode="out-in" name="fade">
                  <div
                    ...
                    key="message"
                    class="inline-block rounded-none border border-green-200 bg-green-100 px-3 py-1.5 dark:border-green-800 dark:bg-green-900/30"
                  >
    ...
    <div class="modal-content mx-auto flex max-h-[90vh] w-full max-w-md flex-col p-4 sm:p-6 md:p-8">
      <div class="mb-6 flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div
            class="flex h-10 w-10 items-center justify-center rounded-none bg-gradient-to-br from-blue-500 to-blue-600"
          >

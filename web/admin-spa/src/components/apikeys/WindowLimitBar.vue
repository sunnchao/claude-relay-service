<template>
  <div class="w-full space-y-1">
    <!-- 时间窗口进度条 -->
    <div
      class="relative h-7 w-full overflow-hidden rounded-none border border-opacity-20 bg-gradient-to-r from-blue-50 to-cyan-100 dark:from-blue-950/30 dark:to-cyan-900/30"
    >
      <!-- 时间进度条背景 -->
      <div
    ...
    <div v-if="costLimit > 0 || requestLimit > 0" class="flex gap-1">
      ...
      <div
        v-if="costLimit > 0"
        class="relative h-6 overflow-hidden rounded-none border border-opacity-20 bg-gradient-to-r from-green-50 to-emerald-100 dark:from-green-950/30 dark:to-emerald-900/30"
      ...
      <div
        v-if="requestLimit > 0"
        class="relative h-6 overflow-hidden rounded-none border border-opacity-20 bg-gradient-to-r from-purple-50 to-indigo-100 dark:from-purple-950/30 dark:to-indigo-900/30"

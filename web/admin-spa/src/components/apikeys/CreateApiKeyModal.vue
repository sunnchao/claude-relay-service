    ...
    <div class="modal fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4">
      <div class="modal-content mx-auto flex max-h-[90vh] w-full max-w-4xl flex-col p-4 sm:p-6">
        ...
        >
          <!-- 创建类型选择 -->
          <div
            class="rounded-none border border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50 p-3 dark:border-blue-700 dark:from-blue-900/20 dark:to-indigo-900/20 sm:p-4"
          >
            <div
              :class="[
            ...
            <div class="space-y-4">
              ...
              <div v-if="form.tags.length > 0">
                ...
                <div class="flex flex-wrap gap-2">
                  <span
                    ...
                    :key="'selected-' + index"
                    class="inline-flex items-center gap-1 rounded-none bg-blue-100 px-3 py-1 text-sm text-blue-800 dark:bg-blue-900/30 dark:text-blue-400"
                  >
                    {{ tag }}
                    <button
              ...
              <div v-if="unselectedTags.length > 0">
                ...
                <div class="flex flex-wrap gap-2">
                  <button
                    ...
                    :key="'available-' + tag"
                    class="inline-flex items-center gap-1 rounded-none bg-gray-100 px-3 py-1 text-sm text-gray-700 transition-colors hover:bg-blue-100 hover:text-blue-700 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-blue-900/30 dark:hover:text-blue-400"
                    type="button"
                    @click="selectTag(tag)"
                  >
              ...
              <div>
                ...
                <div class="flex gap-2">
                  ...
                  />
                  <button
                    class="rounded-none bg-green-500 px-4 py-2 text-white transition-colors hover:bg-green-600"
                    type="button"
                    @click="addTag"
                  >
                    <i class="fas fa-plus" />
          ...
          <div>
            ...
            <div class="space-y-2">
              <div class="flex gap-2">
                <button
                  class="rounded-none bg-gray-100 px-2 py-1 text-xs font-medium hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                  type="button"
          ...
          <div>
            ...
            <!-- 过期模式选择 -->
            <div
              class="mb-3 rounded-none border border-gray-200 bg-gray-50 p-3 dark:border-gray-700 dark:bg-gray-800"
            >
              <div class="flex items-center gap-4">
                <label class="flex cursor-pointer items-center">
                  <input
            ...
            <div v-else>
              ...
              <div class="mt-2 flex flex-wrap gap-2">
                <button
                  ...
                  :key="value.value"
                  class="rounded-none border border-gray-300 px-3 py-1 text-xs hover:bg-gray-100 dark:border-gray-600 dark:hover:bg-gray-700"
                  type="button"
          ...
          <div>
            <div class="mb-2 flex items-center">
              <input
                ...
                class="h-4 w-4 rounded-none border-gray-300 bg-gray-100 text-blue-600 focus:ring-blue-500"
                type="checkbox"
              />
              <label
            ...
            <div v-if="form.enableModelRestriction" class="space-y-3">
              <div>
                ...
                <div
                  class="mb-3 flex min-h-[32px] flex-wrap gap-2 rounded-none border border-gray-200 bg-gray-50 p-2"
                >
                  <span
                    v-for="(model, index) in form.restrictedModels"
                    :key="index"
                    class="inline-flex items-center rounded-none bg-red-100 px-3 py-1 text-sm text-red-800"
                  >
                    {{ model }}
                    <button
                ...
                <div class="space-y-3">
                  ...
                  <div class="flex flex-wrap gap-2">
                    <button
                      ...
                      :key="model"
                      class="flex-shrink-0 rounded-none bg-gray-100 px-3 py-1 text-xs text-gray-700 transition-colors hover:bg-gray-200 sm:text-sm"
                      type="button"
                  ...
                  <div class="flex gap-2">
                    ...
                    />
                    <button
                      class="rounded-none bg-red-500 px-4 py-2 text-white transition-colors hover:bg-red-600"
                      type="button"
          ...
          <div>
            ...
            <div
              ...
              class="rounded-none border border-green-200 bg-green-50 p-3 dark:border-green-700 dark:bg-green-900/20"
            >
              <div>
                ...
                <div class="space-y-1">
                  <div v-for="client in supportedClients" :key="client.id" class="flex items-start">
                    <input
                      ...
                      class="mt-0.5 h-4 w-4 rounded-none border-gray-300 bg-gray-100 text-blue-600 focus:ring-blue-500"
                      type="checkbox"
                      :value="client.id"
                    />
          ...
          <div class="flex gap-3 pt-2">
            <button
              class="flex-1 rounded-none bg-gray-100 px-4 py-2.5 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
              type="button"
              @click="$emit('close')"
            >
              取消
